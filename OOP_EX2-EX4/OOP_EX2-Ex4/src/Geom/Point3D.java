...
public class Point3D implements Geom_element, Serializable 
{
	...
	//x,y,z will present the the point in space
	private double _x,_y,_z;
    
	//constructor that get x,y,z - point3D containe x,y,z, vector?
	...
	//declare array that will split input string that will containe x,y,z , and send them to _x,_y,_z
